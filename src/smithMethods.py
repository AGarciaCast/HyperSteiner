...
def buildQueue(points, triangulationListEdges, triangulationListTriang, mapEdge2Triangle,
    ...
    numEdges = len(edgesWeight)
    while e < numPoints - 1 and i < numEdges:         
...
def heuristicMSTpipeline(points, space="Klein", triangMeth="DT", maxgroup=4,
    ...
    return  resultGraph, verticesDict, steinerVal/fullMSTval, mstGraph, mstTime, triangulationData["triangulationListEdges"], numFST3, numFST4
